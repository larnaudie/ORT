...
function creacionProductos() {
    ...
    if (tipoUsuario === "admin") {
        ...
        document.querySelector("#tblCreacionProductos").innerHTML += `
            ...
            <tr>
            <td><input type="button" id="crearProductoNuevo" value="Crear"></td></tr>`
    }
...
function generarInformeGanancias() {
 ...
 //     //idAnterior = unidadesVendidas[0].idProductoCompra;
       //     let fila =  
    ...
    if (tipoUsuario === "user") {
        ...
        for (let i = 0; i < sistema.productos.length; i++) {
            ...
            < tr >
                ...
                <td><input type="button" value="Comprar" class="btnComprar${i} data-" disabled></td>
                </ > `;
    ...
    if (tipoUsuario === "user") {
        ...
        for (let i = 0; i < sistema.misCompras.length; i++) {
            ...
            < tr >
                ...
                <td><img src="img/${unaCompra.img}" width="100"></td>
    ...
    if (tipoUsuario === "user") {
        ...
        for (let i = 0; i < arrEncontrados.length; i++) {
            ...
            < tr >
                    ...
                    <td><input type="number" id="CantidadUnidades" value="1"></td>
                    <td><input type="button" value="Comprar" class="btnComprarOferta${i}"></td>
                    </ > `;
