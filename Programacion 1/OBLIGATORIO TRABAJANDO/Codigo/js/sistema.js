class Sistema {
    constructor() {
        ...
        this.misCompras = [
            ...
            new ListadoCompras(3, this.productos[2].id, this.usuarios[2].id, 2, this.productos[2].precio, "Pendiente"),
            new ListadoCompras(4, this.productos[1].id, this.usuarios[3].id, 2, this.productos[1].precio, "Cancelada")
        ]
    }
