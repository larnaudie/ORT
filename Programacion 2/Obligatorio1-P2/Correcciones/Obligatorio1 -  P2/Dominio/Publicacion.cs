...
namespace Dominio
{
    ...
    public abstract class Publicacion
    {
        ...
        public Publicacion(string nombre, EstadosEnum.Estados estado, DateTime fechaPublicacion, Cliente? clienteCompra, Usuario? usuarioFinalizo, DateTime? fechaFinalizada = null)
        {
            this.id = ++ultimoId;
            this.nombre = nombre;
            this.estado = estado;
