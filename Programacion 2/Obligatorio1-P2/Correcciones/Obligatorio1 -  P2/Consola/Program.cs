...
namespace Consola
{
    ...
    internal class Program
    {
        ...
        static void ListarClientes()
        {
            ...
            List<Usuario> listaClientes = unSistema.ListarClientes();
        ...
        static void ListarArticulosCategoria(int categoriaFiltrada)
        {
            ...
            { 
                ...
                List<Articulo> listaPorCategoria = unSistema.ListarArticulosCategoria(categoriaFiltrada);
        ...
        static void AgregarArticulo(string nombre, CategoriasEnum.Categorias categoria, int precio)
        {
            try
            {
                // Crea y agrega un nuevo articulo con los datos recibidos
                unSistema.AgregarArticulo(nombre,categoria,precio);
        ...
        static void ListarPublicacionPorFecha(DateTime fechaInicio, DateTime fechaFin)
        {
            try
            {
                List<Publicacion> listaPublicacionesFecha = unSistema.ListarPublicacionPorFecha(fechaInicio, fechaFin);
                // Verificar si la lista está vacía
